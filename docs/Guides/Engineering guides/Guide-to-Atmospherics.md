...
flamability, etc. very few of these conditions are habitable, and it is the job of Atmos Techs to maintain them. Before one changes the stations atmosphere however, it is best to understand 
it, wether to do ones job safely or make ones sabotoge more effective.
...
which is useful if the atmosphere happens to have none. There exist rarer larger capacity varients, colored yellow, and large tanks that cannot fit in the backpack but contain far
more oxygen than the small emergency canisters and are good for spacewalks and extended operations such as mining.

These tanks do not and cannot contain an infinite amount of gas. if your relying on them for a spacewalk, they will eventually run out, so it is reccomended you bring a backup
on very extended walks. The tanks can be filled with gasses from canisters after being inserted into them, though it is reccomended to empty the tanks first. 
...
management due to their larger capacity, and can be turned into devestating weapons with a little effort.
...
The above operations dont require accessing the canisters menu, but it is still worth knowing how to read it. it contains a valve, button to toggle gas release, button to fill (read, equalize)
...
The main use of canisters (aside from acting as buffer/storage for atmos) is to flood fill rooms with the gasses contained inside. this can be done benevolently to fill a oxygenless area
...
Starting with by far the most important, oxygen, the reason why its needed should be abundantly clear. without oxygen players will rapidly take damage and die,
thankfully everyone has a oxygen tank on them at roundstart, and many can be found around the station, but a sudden dissapearence of oxygen is still very capable of killing
numerous people. Something learned from the Apollo 1 crew is that, yes, there is such a thing as too much oxygen. If the atmosphere in an area is almost all oxygen, any flamable gas (plasma)
...
The second gas that you will probably have to worry about is plasma. This (oddly named) substance isnt actually plasma, but instead a mcguffin flamable gas. If it is in the air, the air can catch fire,
so dont let it find a spark. Plasma burns can reach very high temperatures with large amounts of oxygen, but this wil rapidly consume the plasma. Low oxygen burns on the other hand are much
...
nonfunctional. BZ is a potent hallucinagenic agent that can be found within xenobio in science on some maps, it is similarly nonfunctional. Pluoxium can be seen as "safe oxygen", it can replace oxygen
in the atmosphere and be breathable, infact being more effective than oxygen, and has a tendency to be inert and nonreactive, making it an excellent way of controlling fires. Tritium is the exact opposite,
created in high temperature plasma fires in small amounts, large amounts of pure tritium act as a VERY potent fire "accelerant" or catalyst, allowing them to reach some absurd temperatures that even hardsuits wont
save you from. it should be noted that tritium cannot burn on its own, and must be mixed with plasma and oxygen. Miasma is the rarest gas, and does nothing as of now, it is created by dead bodies in small amounts, and is 
...
|         | Plasma         | Flamable, Fuel, Making other gases         | No (planned) | Yes        |
...
While in-air atmospherics is already rather compicated, it goes into the realm of complete absurdity once one factors in piping. many pipes with many different gases and many different
purpouses criss-cross the entire station in an enormous web, all converging onto the atmospherics sub-department itself.

Outside of atmospherics itself, most of the more compplex types of pipes and pipe-interfacers wont be found, and most crew will only have to worry about a few types.
...
Within atmospherics, however, it is an an entirely different beast. Many types of filters and distributors and heaters and coolers litter the area, and the pipes form an incredibly complex spider web.
...
| Picture | Name                   | Purpouse                                                                                                                           | Interface                                                                               |
|---------|------------------------|------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------|
|         | Valve                  | Blocks Equalization until open                                                                                                     | Click to open/close.                                                                    |
|         | Pressure Pump          | Pumps a certain pressure of gas over the boundry.                                                                                  | Click to open menu, change pressure using nearby button, open/close using other button. |
|         | Volume Pump            | Pumps a certain volume of gas over the boundry                                                                                     | Same as above, but for volume.                                                          |
...
|         | Passive Vent           | Equalizes gas between whats in the pipe and whats in the air.                                                                      | None. Set and forget, or hook up to valves/pumps.                                       |
...
|         | Manifold               | Changes the layer of the pipes. can be seen as a "z level" pipes on a level will only connect to pipes on the same level.          | None, connect to pumps/valves for control youll probably need.                          |
|         | Pipe                   | Ordinary pipe, equalizes contents, pressure, and temperature with  adjacent pipes.                                                 | None, use valves/pumps                                                                  |
|         | Pipe Junction          | Region where several pipes meet, equalizing each with eachother and itself.                                                        | none, use valves/pumps.    
...
in-game through the equation PV=NRT, wherin P is pressure, V is volume, N is molarity, R is a constant, and T is temperature. Each of these can cause varying things to occur 
at different values

Low and high pressure will both cause brute damage. This is to say that getting hit by a shockwave of pressure and walking in space wihtout a spacesuit will both be bad for
your health
...
will cause a large increase in pressure. especily dangerous are gases at a high molarity and very low temperature, as a large amount can be fit into a canister or tank, and when released
...
Atmos is both the hardest to learn and hardest to master region of SS13, and most dont bother past the basics. For the skilled atmostech, there are howver great rewards, even beyond
circlejerking to how hot you got plasma to get. A master atmos tech can stop fires before they even begin and give helpful buffs to the entire station, and if a traitor, turn into
the most potent hellfire one has ever seen. what makes atmos especilly powerful is its self reliance. while jobs like roboticist and chemist rely on others, like mining and botany, to get
powerful, the atmos tech can build a chamber that makes the sun look like canada by comparison with only his own know how and tools, no other department required. Learning atmos
