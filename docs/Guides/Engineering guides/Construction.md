...
#Use the remaining 2 sheets of 'metal plates' on the girder.
'False wall'
#Stand where you want the wall.
#Click the 'metal' in your hand to open the construction panel.
# Choose 'Build wall girders' from the list.
# Unsecure the girder you built with a wrench
#click on the girder with atleast 2 'metal plates'
</font>
|-
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
| colspan## "3" rowspan="2" |<font color"Black">
...
## Reinforced Wall===
A more hardy sort of wall, these take significantly longer to deconstruct, but are still fairly easy to place.
...
#Click the  'metal'  in your hand to open the construction panel.
# Choose 'Build girders' form the list.
...
'False Reinforced wall'

#Stand where you want the reinforced wall.
#Click the  'metal'  in your hand to open the construction panel.
# Choose 'Build girder' form the list.
#Unsecure the girder with a 'Wrench'
#Use 1'plasteel' on the girders to reinforce them.
#Use another  'plastee sheet' on the reinforced girders to finish the wall.
...
#Select the Computer Frame icon
#use 'wrench 'to secure
#insert a chip of your choice by clicking on the secured frame with the chip
#click on the frame with a 'Screwdriver 'to screw into place
#Click on the frame with 5 'Medium 'power cables
#click on the frame with 2 'glass sheets '
#Click on the frame with a 'screwdriver 'to connect the monitor
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
| colspan## "3" rowspan="2" |<font color"Black">
#Click on the frame with a 'screwdriver 'to disconnect the monitor
# Click on the frame with a 'crowbar 'to remove glass panel
#Click on the frame with 'wirecutter 'to remove Medium power cables
#Click on the frame with 'screwdriver 'to unscrew the chip
#'wrench 'the frame to unsecure
#Click on unsecured frame with a 'Crowbar' to remove chip
...
N/A
|- </font>
| colspan## "1" style="text-align: center;" |<font color"Black">
N/A
|- </font>
|}
...
{| class## "wikitable" style="width:80%; background-color:#FFFFFF;" cellspacing="0" border"1"
! rowspan## "2" style"background-color:#17232f;" |[[File:Chair 2.0.png|center|thumb]]
! style="background-color:#17232f; width:20%" |Requires to build
! style="background-color:#17232f" |Put Stuff here
|-
...
# Hold at least 5 'Metal plate' in your hand
#Press on the 'Metal plate' in your hand
#Select the APC Frame icon
#Click on the APC Frame to pick up
#Click to install
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
...
# Hold at least 5 'Metal plate' in your hand
#Press on the 'Metal plate' in your hand
#Select the Conveyor Belt icon
#choose the direction you want the conveyor belt to move
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
# Hold at least 5 'Metal plate' in your hand
#Press on the 'Metal plate' in your hand
#Select the Conveyor Belt Switch icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
#Press on the 'Metal plate' in your hand
#Select the Department Battery icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
# Hold at least 2 'Metal plate' in your hand
#Press on the 'Metal plate' in your hand
#Select the Table Frame icon
#Click on frame with 2 metal,glass, or wood to complete the table
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
# Hold at least 2 'Metal plate' in your hand
#Press on the 'Metal plate' in your hand
#Select the Low-voltage Machine Connector icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
also connects stuff
{| class## "wikitable" style="width:80%; background-color:#FFFFFF;" cellspacing="0" border"1"
! rowspan## "2" style"background-color:#17232f;" |[[File:Medium-voltage machine connectors.png|center|thumb]]
! style="background-color:#17232f; width:20%" |Requires to build
! style="background-color:#17232f" |Put Stuff here
|-
|![Metal](Metal.png)<font color"Black">x2</font>
...
# Hold at least 2 'Metal plate' in your hand
#Press on the 'Metal plate' in your hand
#Select the Medium-voltage Machine Connector icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
#Press on the 'Metal plate' in your hand
#Select the Oxygen Canister icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
# Hold at least 1 Metal plate in your hand
#Press on the 'Metal plate' in your hand
#Select the Rack Part icon
#Click on the Rack Part on the floor to assemble
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
| colspan## "3" rowspan="2" |<font color"Black">
#Click on the Rack to kick it, which will cause it to turn back into an item
...
# Hold at least 1 Metal plate in your hand
#Press on the 'Metal plate' in your hand
#Select the Sink icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
| colspan## "3" rowspan="2" |<font color"Black">
##Click on the Sink with a wrench in hand
...
# move the window to the place you want it installed
#click on the window with a screw driver in hand to secure
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
#Select the window icon.
#Pull and drag the window to the place you want it installed.
# Click on the window with a screw driver in hand to anchor it in place.
#Use a crowbar to fully secure the reinforced window.
|- </font>
! colspan## "3" style"background-color:#17232f" |How to Deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
| colspan## "3" rowspan="2" |<font color"Black">
#Use a lit welder on harm intent to heat up the one-way screws.
#Use a screwdriver to remove screws.
#Use a crowbar to pry the window out of its frame.
# Use wirecutters to cut exposed bars on the window.
#Use a wrench to unbolt and unanchor the window.
...
#Press on the glass in your hand
#Select the WhiteServiceDoor icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
...
# Hold at least 1 Metal plate in your hand
#Press on the 'Metal plate' in your hand
#Select the Swivel Chair icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
| colspan## "3" rowspan="2" |<font color"Black">
##Click on the Swivel Chair with a wrench in hand
...
| style## "vertical-align: top; padding: 10px;" |<font color"Black">
# Hold at least wood Plank in your hand
#Press on the wood in your hand
#Select the wood Floor tile icon
|- </font>
! colspan## "3" style"background-color:#17232f" |How to deconstruct
|-
! colspan## "1" style"background-color:#17232f; width:20%" |Tools
